...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border bg-card text-card-foreground shadow-lg", // Increased default radius, slightly stronger shadow
      className
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef<
  HTMLDivElement, // Changed from HTMLParagraphElement to allow more flexible content like <h2>
  React.HTMLAttributes<HTMLDivElement> // Changed from HTMLHeadingElement
>(({ className, ...props }, ref) => (
  <div // Changed from h3 to div for more semantic flexibility by consumers
    ref={ref}
    className={cn(
